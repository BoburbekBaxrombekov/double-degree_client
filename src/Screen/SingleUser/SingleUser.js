                ...
                <div>
                    <div className={'user-page'} style={{ marginTop: 100 }}>
                                ...
                                <div style={{ display: 'flex' }}>
                                    ...
                                    >
                                        ...
                                        <Upload accept={'.pdf'}
                                                ...
                                                name="logo" ref={imgUploader} listType="picture">
                                            <Button>To'lov varaqasini yuklash</Button>
                                        </Upload>
                                    </Form.Item>
                                    <Button loading={loadingBtn} className={'form-btn'} type="primary" htmlType="submit" onClick={() => {
                                        console.log(imgUploader.current);
                                        // imgUploader.current.fileList = null
                                    }}>
                                        {send[language]}
                                    </Button>
                        ...
                        <div className="telegram">
                                        <a href="telegram_link" style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                                            <img src={telegramIcon} alt="" width="25" style={{marginRight: `10px`, marginBottom: `0px`}} />
                                            <h3>Telegram guruhga qo'shilish</h3>
                                        </a>
                                    </div>
                            <Button onClick={handlePrint}
                                    htmlType={"button"}
                                    type={'primary'} disabled={!user.status}>Generate PDF</Button>
