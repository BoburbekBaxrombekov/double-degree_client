              ...
              <div className="fourth_select_form select_form">
                ...
                >
                  ...
                  {language === 0
                    ? obj?.degree === "master" &&
                      listData[0]["master"]
                        .find((l) => l.traing_uz === obj?.traing)
                        ?.universities?.find(
                          (u) => u.training_uz === obj?.university
                        )
                        ?.faculties?.map((p) => {
                          return (
                            <option value={p?.training_uz}>
                              {p?.training_uz}
                            </option>
                          );
                        })
                    : obj?.degree === "master" &&
                      listData[0]["master"]
                        .find((l) => l.country_ru === obj?.country)
                        ?.universities?.find(
                          (u) => u.training_ru === obj?.university
                        )
                        ?.faculties?.map((p) => {
                          return (
                            <option value={p?.training_ru}>
                              {p?.training_ru}
                            </option>
                          );
                        })}
