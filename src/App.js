...
import PaidPages from "./Screen/paidpapers/paidpapers";
...
function App() {
  ...
  const MainApi = "http://185.217.131.79:4000/";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/paidpages" element={<PaidPages />} />
        ...
        <Route
          path="/statistics"
          element={<Statistics language={language}/>}
        />
        <Route
          path="/login"
