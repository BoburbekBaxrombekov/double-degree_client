...
import telegramIcon from "../../telegram.webp";
        ...
        <div className="navbar-container">
          <div className={"navbar-item"}>
            <div className="col-1">
              <div>
                <Link to="/">
                  ...
                  <span className="costum-logo-text">
            ...
            <div className="col-2">
              ...
              <div className="commands d-none">
                <div className="gerb">
                  <img src={gerbImg} alt="" width="35" />
                </div>
                <div className="telegram_main">
                  <a href="telegram_link"><img src={telegramIcon} alt="" width="25" /></a>
                </div>
                <button className="zoom_btn zoom_minus">A-</button>
                <button className="zoom_btn zoom_default">A</button>
                <button className="zoom_btn zoom_plus">A+</button>
                <button className="zoom_btn theme_btn">
